...
Route::post('/home/add', 'App\Http\Controllers\RicercaController@addPref');
Route::post('/home/addplay', 'App\Http\Controllers\PlaylistController@addSong');
...
Route::post('/ricerca/add', 'App\Http\Controllers\RicercaController@addPref');
...
Route::post('/ricerca/addplay', 'App\Http\Controllers\PlaylistController@addSong');
...
Route::get('/playlist/all', 'App\Http\Controllers\PlaylistController@getPlaylist');
